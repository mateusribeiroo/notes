  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed z-10 left-1/2 top-1/2 -translate-x-1/2 
        -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md 
          ...
          <form className="flex flex-1 flex-col">
            ...
            {isRecording ? (
              <button 
                ...
                className="bg-slate-900 w-full text-center font-medium py-4 text-slate-300
                hover:text-slate-100 flex items-center justify-center gap-2">
              ...
              <button 
                ...
                className="bg-lime-400 w-full text-center font-medium py-4 text-lime-950
                hover:bg-lime-500">
                  Salvar nota
              </button>
            )}
